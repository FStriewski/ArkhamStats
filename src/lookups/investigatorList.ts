...
export const investigatorList = [
  ...
  },
  {
    ...
    deck_options: [
      ...
      { faction: ['seeker', 'neutral'], level: { min: 0, max: 5 } },
      {
        ...
        limit: 5,
        error:
          'You cannot have more than 5 cards that are not Seeker or Neutral'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    deck_options: [
      { faction: ['mystic', 'neutral'], level: { min: 0, max: 5 } },
      {
        ...
        limit: 5,
        error:
          'You cannot have more than 5 cards that are not Mystic or Neutral'
      }
    ]
  },
  {
    ...
    deck_options: [
      { faction: ['survivor', 'neutral'], level: { min: 0, max: 5 } },
      {
        ...
        limit: 5,
        error:
          'You cannot have more than 5 cards that are not Survivor or Neutral'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    deck_options: [
      {
        faction: ['survivor', 'guardian', 'seeker', 'rogue', 'mystic'],
        level: { min: 0, max: 3 },
        atleast: { factions: 3, min: 7 },
